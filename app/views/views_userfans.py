...
#个人资料视图
class UserFansHandler(CommonHandler):
        ...
        if id:
            ...
            try:
                if q:
                    ...
                    model = session.query(User).filter(Relation.follower_id == id, Relation.Uid == User.Uid).order_by(
                        User.UcreateAt.desc())
            ...
            self.render("userfans.html", data=data)