...
from app.models.models import Relation_video_user_like,Video

#个人资料视图
class UserLikeHandler(CommonHandler):
        ...
        if id:
            ...
            try:
                if q:
                    ...
                    model = session.query(Video).filter(Relation_video_user_like.Uid == id ,Relation_video_user_like.Vid == Video.Vid).order_by(Video.VcreateAt.desc())
            ...
            self.render("userlike.html", data=data)